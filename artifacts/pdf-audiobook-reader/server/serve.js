...
function servePrivacyPage(res, privacyPageTemplate) {
  res.writeHead(200, { 'content-type': 'text/html; charset=utf-8' });
  res.end(privacyPageTemplate);
}
...
const privacyPageTemplate = fs.readFileSync(PRIVACY_TEMPLATE_PATH, 'utf-8');
...
const server = http.createServer((req, res) => {
  ...
  if (pathname === '/privacy') {
    return servePrivacyPage(res, privacyPageTemplate);
  }
